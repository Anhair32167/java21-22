...
public class RentCompanyLocks{
	static final ReentrantReadWriteLock carsLock = new ReentrantReadWriteLock();
	static final ReentrantReadWriteLock modelsLock = new ReentrantReadWriteLock();
	static final ReentrantReadWriteLock driversLock = new ReentrantReadWriteLock();
	static final ReentrantReadWriteLock recordsLock = new ReentrantReadWriteLock();
	...
	public static void lockRemoveCar(boolean flag) {
		lockUnlock(flag, write_index, records_index);
		lockUnlock(flag, write_index, cars_index);
	}
	...
	public static void lockReturnCar(boolean flag) {	
		lockUnlock(flag, write_index, records_index, cars_index, models_index);	
	}

	public static void lockGetMostPopularCarModels(boolean flag) {
		lockUnlock(flag, read_index, records_index, cars_index);
	}
