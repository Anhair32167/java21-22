...
@Configuration
public class AuthenticationCofiguration implements UserDetailsService{
	...
	public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {	
		UserAccount user = repo.findById(username).orElseThrow(() -> new UserNotFoundException(username));
